...
<template>
  <section>
    ...
    <div class="work-items">
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/src/views/assets/images/bigbrew.png'">
      ...
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/src/views/assets/images/coffee.png'">
