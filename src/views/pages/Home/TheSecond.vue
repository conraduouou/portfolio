...
<template>
  <section>
    ...
    <div class="work-items">
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/images/bigbrew.png'">
        This was my first project using Flutter, done for the BigBrew milktea franchise.
      </WorkItem>
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/images/nft.png'">
        This was a side hustle offered to me by my co-worker, done in two (2) weeks!
      </WorkItem>
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/images/toolmart.png'">
      ...
      <WorkItem class="work-item" :is-mobile=true :asset-url="'/images/coffee.png'">
      ...
      <WorkItem class="work-item" :asset-url="'/images/hospital.png'">
      ...
      <WorkItem class="work-item" :asset-url="'/images/diligens.png'">
